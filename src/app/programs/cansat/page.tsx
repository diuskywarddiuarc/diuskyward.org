...
import { Radio, Database, Cpu, Wifi } from "lucide-react";
import Link from "next/link";

export default function CanSatProgramPage() {
    return (
        <div className="flex flex-col w-full bg-rl-black min-h-screen">
            ...
            <section className="relative h-[80vh] min-h-[600px] overflow-hidden flex flex-col items-center justify-center text-center w-full">
                ...
                <div className="relative z-20 max-w-[1400px] px-6">
                    <span className="text-rl-light-grey font-bold tracking-[0.3em] uppercase mb-4 block">Telemetry & Payloads</span>
            ...
            <section className="py-24 md:py-32 w-full">
                <div className="max-w-[1400px] mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-40">
                        <div>
                            <h2 className="text-5xl md:text-7xl font-heading font-black mb-10 tracking-tight leading-none uppercase">
                                Atmospheric<br />Data<br />Collection
                            </h2>
                        </div>
                        <div className="flex flex-col justify-center">
                            <p className="text-xl md:text-2xl text-rl-light-grey font-light leading-relaxed mb-8">
                                The CanSat program focuses on miniaturization. We design, build, and launch volume-constrained payloads (the size of a soda can) to collect real-time atmospheric data, validate descent control hardware, and establish remote RF comms.
                            </p>
                            <div className="grid grid-cols-2 gap-8 pt-8 border-t border-rl-white/20">
                                <div>
                                    <span className="block text-4xl font-heading font-bold mb-2">350g</span>
                                    <span className="text-rl-light-grey text-sm tracking-widest uppercase">Max Mass</span>
                                </div>
                                <div>
                                    <span className="block text-4xl font-heading font-bold mb-2">900Mhz</span>
                                    <span className="text-rl-light-grey text-sm tracking-widest uppercase">Telemetry Frequency</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-40">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-y border-rl-white/20">
                            ...
                            <div className="p-10 border-b md:border-b-0 md:border-r border-rl-white/20 group hover:bg-rl-dark-grey transition-colors">
                                ...
                                <h3 className="text-2xl font-heading font-bold uppercase mb-4 tracking-widest">AVIONICS</h3>
                                <p className="text-rl-light-grey font-light leading-relaxed">
                                    Custom printed circuit boards (PCBs) hosting microprocessors, barometric pressure sensors, IMUs, and GPS modules within a cylindrical form factor.
                                </p>
                            </div>

                            {/* System 2 */}
                            <div className="p-10 border-b md:border-b-0 md:border-r border-rl-white/20 group hover:bg-rl-dark-grey transition-colors">
                                <Wifi className="w-12 h-12 text-rl-white mb-8" strokeWidth={1} />
                                <h3 className="text-2xl font-heading font-bold uppercase mb-4 tracking-widest">RF COMMS</h3>
                                <p className="text-rl-light-grey font-light leading-relaxed">
                                    Simulating satellite communication links. Utilizing LoRa transceivers to transmit 1Hz data packets securely to our ground station.
                                </p>
                            </div>

                            {/* System 3 */}
                            <div className="p-10 group hover:bg-rl-dark-grey transition-colors">
                                <Database className="w-12 h-12 text-rl-white mb-8" strokeWidth={1} />
                                <h3 className="text-2xl font-heading font-bold uppercase mb-4 tracking-widest">GROUND STATION</h3>
                                <p className="text-rl-light-grey font-light leading-relaxed">
                                    A Python-based GUI dashboard filtering live telemetry, plotting altitude/pressure graphs, and rendering a 3D simulation of the payload&apos;s orientation.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full aspect-[21/9] bg-rl-dark-grey relative overflow-hidden mb-40 border-y border-rl-white/10">
                        <div className="absolute inset-0 bg-[url('/media/images/network-comms.png')] bg-cover bg-center opacity-80 mix-blend-luminosity grayscale hover:grayscale-0 transition-all duration-1000" />
                    </div>

                    {/* Join The Program */}
                    <div className="border border-rl-white/20 p-16 flex flex-col items-center justify-center text-center">
                        <Radio className="w-16 h-16 text-rl-white mb-8" strokeWidth={1} />
                        <h2 className="text-4xl md:text-5xl font-heading font-black mb-6 tracking-tight uppercase">
                            Join Project Stratos
                        </h2>
                        <p className="text-xl text-rl-light-grey font-light max-w-2xl mx-auto mb-10">
                            We are recruiting software engineers for ground station UI development and electrical engineers for compact PCB design.
                        </p>
