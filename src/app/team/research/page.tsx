...
const RESEARCH_TEAM = [
    { name: "Farzana Mithi", title: "Documentation Lead", image: "/media/images/team/mithi.jpg" },
    { name: "null", title: "Research Lead", image: "/media/images/team/research-lead.jpg" },
    { name: "null", title: "Data Analysis Engineer", image: "/media/images/team/data-analyst.jpg" },
    { name: "null", title: "Simulation Specialist", image: "/media/images/team/simulation-specialist.jpg" },
    { name: "null", title: "Experimental Validation Officer", image: "/media/images/team/validation-officer.jpg" },
];
            ...
            <section className="py-20 px-6 max-w-[1400px] mx-auto w-full">
                <div className="max-w-3xl mb-20 mx-auto text-center">
                    <p className="text-xl text-rl-light-grey font-light leading-relaxed mb-6">
                        The Research Division drives innovation through advanced simulation, rigorous data analysis, and experimental validation of all DIU Skyward initiatives. Our engineers create computational models, analyze flight data, and validate theoretical designs against real-world performance metrics.
                    </p>
                    <p className="text-xl text-rl-light-grey font-light leading-relaxed">
                        We bridge the gap between concept and reality, ensuring every mission is backed by solid science and comprehensive testing protocols.
                    </p>
                </div>
            </section>
