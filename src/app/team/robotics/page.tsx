...
const ROBOTICS_TEAM = [
    { name: "Tahmid Khan", title: "Chief Robotics Engineer", image: "/media/images/team/tahmid-khan.jpg" },
    { name: "Samiul Islam", title: "Navigation Systems Lead", image: "/media/images/team/samiul-islam.jpg" },
    { name: "Fahim Shahriar", title: "Mechanical Designer", image: "/media/images/team/fahim-shahriar.jpg" },
    { name: "Anika Tabassum", title: "CV Specialist", image: "/media/images/team/anika-tabassum.jpg" },
];

export default function RoboticsDivisionPage() {
            ...
            <section className="py-20 px-6 max-w-[1400px] mx-auto w-full">
                <div className="max-w-3xl mb-20 mx-auto text-center">
                    <p className="text-xl text-rl-light-grey font-light leading-relaxed mb-6">
                        The Robotics Division develops autonomous rovers designed to operate in extreme terrain, inspired by Mars exploration missions. Our engineers specialize in rocker-bogie suspension systems, computer vision for navigation, LIDAR mapping, and robotic manipulation for sample collection.
                    </p>
                    <p className="text-xl text-rl-light-grey font-light leading-relaxed">
                        We integrate cutting-edge sensors, custom-designed mechanical systems, and AI-driven autonomy to create rovers capable of independent mission execution.
                    </p>
                </div>
            </section>
